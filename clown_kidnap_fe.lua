local victimName = "Player1" --[[Full name pls :) ]]
function kidnap(victim)
	--[[CLOWN VAN BY DMS
	--its bad
	...
	local 	player = game.Players[Victim]
...
for i = 1,#game.Players:GetPlayers() do
	task.spawn(function()  kidnap(game.Players:GetPlayers()[i].Name) end)
end
else 
  kidnap(victimName)
end
