local victim = "Player1" --[[your name here pls :) ]]
Player=game:GetService("Players")[victim]
...
Damagefunc=function(hit,minim,maxim,knockback,Type,Property,Delay,KnockbackType,decreaseblock)
	...
	if h~=nil and hit.Parent.Name~=Character.Name and hit.Parent:FindFirstChild("Torso")~=nil then
		...
		c.Name="creator"
		c.Value=game:service("Players")[victim]
		c.Parent=h
...
function ALLAHUAKBAR()
	attack = true
	local colors = {"White","White","White"} -- The only 3 colors, adding more will error.
	local chat = game:GetService("Chat")
	chat:Chat(Head,"PRAISE ALLAH " .. math.random(10000) .. " TIMES A DAY! ALLAHUAKBAR", colors[math.random(1,3)] )
	for i = 0,1,0.05 do
		swait()
