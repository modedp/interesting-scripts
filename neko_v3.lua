...
local nekoall = 5277902239 --dependencies (nekofolder.rbxm)
...
do
	...
	local function PerfectionWeld(wldmod)
	
		local Parts = GetBricks(script.Parent)
		local PrimaryPart = script.Parent.Torso.REF
...
local LArmHandle = script.LArmYes.LeftArm:WaitForChild'REF'
for i,v in pairs(script.LArmYes.LeftArm:GetChildren()) do
v.Anchored = false
end
...
----------------------------------------------------------------------------------
local RArmHandle = script.RArmYes.RightArm:WaitForChild'REF'
for i,v in pairs(script.RArmYes.RightArm:GetChildren()) do
v.Anchored = false
end
...
----------------------------------------------------------------------------------
local TorsoHandle = script.TorsoYes.Torso:WaitForChild'REF'
for i,v in pairs(script.TorsoYes.Torso:GetChildren()) do
v.Anchored = false
end
local LeftAWeld = IT("Weld")
...
local LLegHandle = script.LLegYes.LeftLeg:WaitForChild'REF'
for i,v in pairs(script.LLegYes.LeftLeg:GetChildren()) do
v.Anchored = false
end
-------
...
----------------------------------------------------------------------------------
local RLegHandle = script.RLegYes.RightLeg:WaitForChild'REF'
for i,v in pairs(script.RLegYes.RightLeg:GetChildren()) do
v.Anchored = false
end
...
blush.Texture = "http://www.roblox.com/asset/?id=3523974768"
	local ParticleEmitter0 = Instance.new("ParticleEmitter")
	ParticleEmitter0.Parent = script.TorsoYes.Torso.REF
	ParticleEmitter0.Speed = NumberRange.new(0.5, 0.5)
	ParticleEmitter0.Rotation = NumberRange.new(0, 360)
	ParticleEmitter0.Enabled = true
	ParticleEmitter0.Texture = "rbxassetid://244221440"
	...
	ParticleEmitter0.VelocitySpread = 360
	local ParticleEmitter1 = Instance.new("ParticleEmitter")
	ParticleEmitter1.Parent = script.TorsoYes.Torso.Out
	ParticleEmitter1.Speed = NumberRange.new(0.5, 0.5)
	ParticleEmitter1.Rotation = NumberRange.new(0, 360)
	ParticleEmitter1.Enabled = true
	ParticleEmitter1.Texture = "rbxassetid://244221440"
...
Torso.Transparency = 0
local shirt = Player.Character:WaitForChild("Shirt")
shirt.ShirtTemplate = "rbxassetid://10248083"
	wait(0.2)
	ParticleEmitter0.Enabled = false
	ParticleEmitter1.Enabled = false
	game:GetService("Debris"):AddItem(ParticleEmitter0,2)
