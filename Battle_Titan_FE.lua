--[[TO USE THIS PROPERLY, DOWNLOAD THE RBXM AND REUPLOAD AS YOUR OWN MODULE!!! THIS IS ONLY A PLACEHOLDER IT DOES NOT WORK WITHOUT THE CONVERTER]]

task.wait(0.5)
local RealPlayer = game.Players[script.User.Value]
...
do
	...
	Event.Parent = RealPlayer.Character
