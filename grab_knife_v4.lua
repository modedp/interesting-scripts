--[[these scripts keep getting more and more dependent. what happens when FE is enabled skids!]]
...
if workspace.FilteringEnabled == false then
	...
	notify('If you picked this script first just because of grab knife your a fucking retard check out the other scripts')
end
	...
	for i,v in pairs(rekt) do
		if v.Parent ~= nil then
			if v:FindFirstChildOfClass('Humanoid') and v:FindFirstChildOfClass('Humanoid').Health>0 then
				...
				v:FindFirstChildOfClass('Humanoid')w.WalkSpeed = 0
