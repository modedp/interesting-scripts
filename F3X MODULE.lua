...
function F3X.Object(object)
    ...
    if object:IsA("BasePart") then
        ...
        function proxy:BreakJoints() local parts = {} for _,part in pairs(object:GetTouchingParts()) do table.insert(parts, part) end serverEndpoint:InvokeServer("CreateWelds", parts, object) end
